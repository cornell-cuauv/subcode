...
build.build_cmd('auv-hydromathd', ['hydromathd.cpp', 'udp_receiver.cpp', 'udp_sender.cpp', 'comms.cpp', 'pinger_tracking.cpp'],
...
build.install('auv-hydro-comms-filtered-plot', 'hydrocode/scripts/comms_baseband_plot.py')
