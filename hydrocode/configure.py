...
build.build_cmd('auv-pingerd', ['pingerd/main.cpp', 'pingerd/pinger.cpp', 'pingerd/constants.cpp', 'common/udp_receiver.cpp', 'common/udp_sender.cpp'], auv_deps=['shm'], deps=['common/liquid'])
