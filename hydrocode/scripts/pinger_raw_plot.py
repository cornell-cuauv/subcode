...
(gain_line, ) = ax2.plot(x, y, 'k-', linewidth = 0.5)
...
while 1:
	...
	print("Received pinger raw plot")
	...
	sig0_line.set_ydata(smooth_values[0])
	sig1_line.set_ydata(smooth_values[1])
	sig2_line.set_ydata(smooth_values[2])
	sig3_line.set_ydata(smooth_values[3])
