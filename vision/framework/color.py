...
def mask_from_labels(labels, centers):
    ...
    the smae label is set to 255, while all other points are set to 0.
...
def mask_from_labels_target_color(labels, centers, target_color, distance_func=color_dist):
    ...
    all points in the smae label is set to 255, while all other points are set
    to 0.  Generates one mask from each centeroid in centers.
    :param labels: The labels generated by kmeans.
    :param centers: The centeroids generated by kmeans.
    :param target_color: The target color used to choose the label generating the maks
    :param distance_func: The function that takes in two 3-chanel colors to
