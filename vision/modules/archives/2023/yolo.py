...
class Yolo(ModuleBase):
    def __init__(self, *args, **kwargs):
        ...
        self.model = YOLO('vision/yolo/auv_models/everythin640v3.pt')
        self.consistency = ConsistentTargeting(20, 'pos', num_detections=4)

    def module_options_settings(self):
        """
        Module options are set here. This is the first thing that is called.
        """
        if self.options["off"]:
