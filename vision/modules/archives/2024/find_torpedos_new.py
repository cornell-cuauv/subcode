...
class DepthTorpedo(ModuleBase):
    def process(self, img):
        ...
        if board_result is not False:
            ...
            for i in range(len(goals_circles)):
                ...
                print('cent',cent)
                draw_circle(img,cent,int(rad),color = (255,255,255),thickness=20)
    ...
    def find_board(self,img,contours):
        ...
        norm_x, norm_y = self.normalized((int(center_x),int(center_y)))
    ...
    def find_goals(self,contours,board_center, tr,tl,br,bl):
        ...
        while i < len(sorted_pos_goals) and all_found is False:
            ...
            if g != 0:
                ...
                norm_x, norm_y = self.normalized((int(sorted_pos_goals[i][1][0]), int(sorted_pos_goals[i][1][1])))
    ...
    def in_box(self,center,radius,corners):
        ...
        for c in range(4):
            ...
            if c+1 < 4:
                adj_edge = corners[c+1]-origin
            else:
                adj_edge = corners[0]-origin
# 
