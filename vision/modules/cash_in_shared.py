...
def get_shared_options(is_forward):
    ...
    return [
        ...
        options.IntOption("color_dist_min_yellow_funnel", (137, 0)[is_forward], 0, 255),
        options.IntOption("color_dist_max_yellow_funnel", (250, 35)[is_forward], 0, 255),
...
def threshold(img):
    ...
    if shared.options["in_simulator"]:
        ...
        if shared.is_forward:
            ...
            dist_from_yellow = np.linalg.norm(img.astype(int) - [241, 111, 176], axis=2).astype(int)
