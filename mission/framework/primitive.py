...
async def zero_without_heading(pitch: bool = True, roll: bool = True) -> None:
    """
...
async def zero(pitch: bool = True, roll: bool = True) -> None:
    """
...
async def run_with_timeout(coroutine : Any, seconds: float):
    ...
    Returns:
        True if the coroutine runs to completion and False if it times out
    """
